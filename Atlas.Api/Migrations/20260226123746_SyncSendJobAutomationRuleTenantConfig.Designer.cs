...
namespace Atlas.Api.Migrations
{
    ...
    [Migration("20260226123746_SyncSendJobAutomationRuleTenantConfig")]
    partial class SyncSendJobAutomationRuleTenantConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Atlas.Api.Models.AddOnService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AddOnServices", (string)null);
                });
            ...
            modelBuilder.Entity("Atlas.Api.Models.Billing.BillingInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<decimal>("TaxAmountInr")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TaxGstRate")
            ...
            modelBuilder.Entity("Atlas.Api.Models.Billing.BillingPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Atlas.Api.Models.Billing.BillingPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Atlas.Api.Models.Billing.TenantCreditsLedger", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TenantCreditsLedger", (string)null);
                });

            modelBuilder.Entity("Atlas.Api.Models.Billing.TenantSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("NextInvoiceAtUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Atlas.Api.Models.BookingInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Atlas.Api.Models.ChannelConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "PropertyId", "Provider")
                        .IsUnique();

                    b.ToTable("ChannelConfigs", (string)null);
                });
            ...
            modelBuilder.Entity("Atlas.Api.Models.ListingAddOn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ListingId", "AddOnServiceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Atlas.Api.Models.ListingExternalCalendar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SyncedEventCount")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ListingExternalCalendars", (string)null);
                });
            ...
            modelBuilder.Entity("Atlas.Api.Models.ListingPricingRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "ListingId", "RuleType");

                    b.ToTable("ListingPricingRules", (string)null);
                });
            ...
            modelBuilder.Entity("Atlas.Api.Models.PromoCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Atlas.Api.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("HostResponseAt")
                        .HasColumnType("datetime");
            ...
            modelBuilder.Entity("Atlas.Api.Models.Billing.BillingPayment", b =>
                {
                    b.HasOne("Atlas.Api.Models.Billing.BillingInvoice", "Invoice")
                        .WithMany()
            ...
            modelBuilder.Entity("Atlas.Api.Models.Billing.TenantSubscription", b =>
                {
                    b.HasOne("Atlas.Api.Models.Billing.BillingPlan", "Plan")
                        .WithMany()
            ...
            modelBuilder.Entity("Atlas.Api.Models.ListingAddOn", b =>
                {
                    b.HasOne("Atlas.Api.Models.AddOnService", "AddOnService")
                        .WithMany()
